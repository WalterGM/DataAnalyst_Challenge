CREATE OR REPLACE PROCEDURE import_data_type(chunk_size INT)
AS $$
...
BEGIN
    file_handle := 'C:\Temp\ce.datatype.txt'; -- Replace with the actual path to your file
    ...
    LOOP
        ...
        END IF;
        EXECUTE 'INSERT INTO "ce.datatype" (data_type_code, data_type_text) VALUES ($1, $2)' USING data_array[1]:: bigint, data_array[2];
